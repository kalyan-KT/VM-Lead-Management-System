...
import { WebsiteLeadDetail } from './WebsiteLeadDetail';
...
export function WebsiteLeadsView({ leads, onUpdateLead, onDeleteLead }: WebsiteLeadsViewProps) {
    ...
    // Export Function
    const handleExport = () => {
        const headers = ['Date', 'Name', 'Email', 'Company', 'Division', 'Service', 'Budget', 'Status'];
        const csvContent = [
            headers.join(','),
        ...
        link.download = `website_leads_${new Date().toISOString().split('T')[0]}.csv`;
        link.click();
    };
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-gray-50/50 dark:bg-gray-900/50 hover:bg-gray-50/50 dark:hover:bg-gray-900/50">
                            ...
                            <TableHead className="text-xs font-semibold uppercase text-muted-foreground">Division</TableHead>
                            <TableHead className="text-xs font-semibold uppercase text-muted-foreground">Service</TableHead>
                        ...
                        {filteredLeads.length === 0 ? (
                            ...
                            filteredLeads.map((lead) => (
                                ...
                                >
                                    ...
                                    <TableCell className="text-sm text-muted-foreground">{lead.division || '-'}</TableCell>
                                    <TableCell className="text-sm font-medium">{lead.service || '-'}</TableCell>
                                    <TableCell>
                                        {lead.budget ? (
